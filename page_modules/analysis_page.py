        ...
        with tab3:
            ...
            # -----------------------------
                ...
                if city_choice == "全台":
                    ...
                    top_n = max(1, round(len(trans_counts)*0.3))  # 取前30%
            ...
            # -----------------------------
                ...
                pop_grouped = pop_df.groupby("民國年")["人口數"].last().reset_index()
                merged = pd.merge(pop_grouped, trans_grouped, on="民國年", how="left").fillna(0)
